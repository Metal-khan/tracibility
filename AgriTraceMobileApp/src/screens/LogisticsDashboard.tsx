...
type LogisticsDashboardNavigationProp = StackNavigationProp<RootStackParamList, 'LogisticsDashboard'>;

const LogisticsDashboard: React.FC = () => {
  const navigation = useNavigation<LogisticsDashboardNavigationProp>();
  const userName = "Logistics User";
  ...
  const menuItems = [
    ...
    { name: "My Shipments", icon: "truck-delivery", screen: "LogisticsShipmentList" },
    { name: "My Account", icon: "account-box-outline", screen: "MyAccount" },
    { name: "Scan History", icon: "history", screen: "ScanHistory" },
  ];
        ...
        <View style={styles.cardsContainer}>
          <FlatList
            ...
            renderItem={({ item }) => (
              ...
              >
                <MaterialCommunityIcons name={item.icon as any} size={40} color="#2563eb" />
